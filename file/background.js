...
// using mouse click down
    ...
    function object(){
        ...
        // back
        for(row=0.125;row>-3;row-=0.125){
            for(count=-0.125;count<2;count+=0.125){
                draw(gl.LINE_LOOP, back, cursor_color,[count,row,0.1,0.0]);
            }
        }
        ...
        // draw(gl.TRIANGLE_FAN,left_eye,cursor_line_color,[4.0,-6.0,1.0,0.5]);
    }
    // drawing square
